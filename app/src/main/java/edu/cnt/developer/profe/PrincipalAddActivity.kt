...
class PrincipalAddActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //enableEdgeToEdge()
        Log.d("MYAPP", "PrincipalAddActivity: onCreate: start")

        setContentView(R.layout.activity_principal_add)
...
//        }
        ...
        val gridView = findViewById<GridView>(R.id.gridViewMenuAdd)
        val adapter = PrincipalAddMenuAdapter(this, menuItems)
        gridView.adapter = adapter

        Log.d("MYAPP", "PrincipalAddActivity: onCreate: step 1")
//        Log.d("MYAPP", "PrincipalActivity: onCreate: step 1: menuItems = ${menuItems}")
        ...
        Log.d("MYAPP", "PrincipalAddActivity: onCreate: step 2")

        //val intent = Intent(this, ProductsActivity::class.java)
        //val intent = Intent(this, DogsActivity::class.java)
        //val intent = Intent(this, UsersListActivity::class.java)
        //startActivity(intent)
        Log.d("MYAPP", "PrincipalAddActivity: onCreate: finish")
